...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    {
        Quaternion _rot = Quaternion.Euler(new Vector3(gameObject.transform.rotation.eulerAngles.x, gameObject.transform.rotation.eulerAngles.y + (movement.x * rotSpeed * 100f * Time.deltaTime), gameObject.transform.rotation.eulerAngles.z));
